...
const Contact = () => {
  return (
    <div className="w-full bg-[#374887] py-16 px-4 z-0 text-white">
      <div className="max-w-md mx-auto text-center">
        ...
        <p className="text-lg mb-4">You can contact me on my mail! navidmirzad@hotmail.com</p>
        <p className="text-lg mb-4">Don't like mails? Send me a <a href="https://www.linkedin.com/in/navidmirzad/" className='text-[#0077B5]'>LinkedIn</a> message instead 👋</p>
