  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      ...
      <div onClick={handleNav} className='block md:hidden'>
        ...
        <ul className={!nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-600 bg-[#5a4d48] ease-out duration-500" : "fixed left[-100%]"}>
        <h1 className="w-full text-3xl font-bold text-[#dfbdbd] m-4">Navid</h1>
          <li className="p-4 border-b border-gray-400"> Home</li>
          <li className="p-4 border-b border-gray-400">About</li>
          <li className="p-4 border-b border-gray-400">Portfolio</li>
          <li className="p-4 border-b border-gray-400">Contact</li>
          <a
            href="/CVPRAKTIK.pdf" className="flex items-center p-2 border mt-4" download><FaRegFilePdf className="mr-2" />
            Resume</a>
        </ul>
      </div>
  );
